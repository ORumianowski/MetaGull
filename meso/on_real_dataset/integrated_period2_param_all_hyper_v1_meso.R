...
out1 <- jags(jags.data, inits, parameters, "/lustre/rumianowskio/models/integrated_period2_all_hyper.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/integrated_period2_all_hyper.Rda")
