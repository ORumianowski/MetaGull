...
load(file = "/lustre/rumianowskio/real_dataset_v3/B.Rda")
load(file = "/lustre/rumianowskio/real_dataset_v3/marr_reel.Rda")
...
out1 <- jags(jags.data, inits, parameters, "/lustre/rumianowskio/model_v10_6_cmr.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/out1_integrated_v10_6_real_cmr.Rda")
