  ...
  load(file = "/lustre/rumianowskio/real_dataset/v1_filet/marr_filet5.Rda")
  
  # load(file = "1_formatage/real_dataset/v1_filet/B.Rda")
  # load(file = "1_formatage/real_dataset/v1_filet/marr_filet4.Rda")
  ...
  out1 <- jags(jags.data, inits, parameters, "/lustre/rumianowskio/models/semi_cmr_AE_v12_prior_p_hyper.txt",
               n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
               parallel=TRUE)
  
  save(out1, file = "/lustre/rumianowskio/out1_cmr_hyper_filet5.Rda")
