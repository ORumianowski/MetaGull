...
out1 <- jags(jags.data, inits, parameters, "/lustre/rumianowskio/models/semi_cmr_AE_v12_prior_p.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/out1_cmr_AE_v12_prior_p.Rda")
