...
# load(file = "/lustre/rumianowskio/real_dataset/period2/B_P2.Rda")
...
out1 <- jags(jags.data, inits, parameters, "/lustre/rumianowskio/models/cmr_period2_v2_disp.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/cmr_period2_v2_disp.Rda")
