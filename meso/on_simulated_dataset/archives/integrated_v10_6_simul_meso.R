...
load(file = "/lustre/rumianowskio/simulated_dataset/B.Rda")
load(file = "/lustre/rumianowskio/simulated_dataset/marr.Rda")
...
out1 <- jags(jags.data, inits, parameters, "/lustre/rumianowskio/model_v10_6_simul.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/out1_integrated_v10_6_simul.Rda")
