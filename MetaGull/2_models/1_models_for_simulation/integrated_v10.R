...
#setwd("C:/Users/33763/Documents/CMRi/0_Github/Metapopulation-dynamics-following-a-major-disturbance---Master-s-thesis/1_Modélisation/1_IPM/5_IPM_jags/version_9")
...
# load(file = "/lustre/rumianowskio/simulated_dataset_v9/B.Rda")
# load(file = "/lustre/rumianowskio/simulated_dataset_v9/marr.Rda")

load(file = "simulated_dataset_v6/B.Rda")
load(file = "simulated_dataset_v6/marr.Rda")
...
pop_init = data.frame(estim = B[,1]) %>% 
  ...
  mutate(N_inf = estim*(repro_ratio)*0.7+1)%>% 
...
out1 <- jags(jags.data, inits, parameters, "model_v10.txt",
