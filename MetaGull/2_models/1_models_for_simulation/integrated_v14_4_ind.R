...
cat(file = "2_models/1_models_for_simulation/models/integrated_v14_4.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/1_models_for_simulation/models/integrated_v14_4.txt",
