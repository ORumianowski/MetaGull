...
cat(file = "2_models/1_models_for_simulation/model_v10_6_simul.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/1_models_for_simulation/model_v10_6_simul.txt",
