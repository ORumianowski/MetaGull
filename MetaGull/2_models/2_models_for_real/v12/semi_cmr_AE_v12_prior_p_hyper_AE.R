...
cat(file = "2_models/2_models_for_real/v12/models/semi_cmr_AE_v12_prior_p_hyper_AE.txt", "
model {
 # -------------------------------------------------
  # Stages:
  ...
  eta_t[n.colony, 1, t] <-  (eta_ext[n.colony, 1, t] / (sum(eta_ext[n.colony,1:4, t])-0.301))  
  eta_t[n.colony, 2, t] <-  (eta_ext[n.colony, 2, t] / (sum(eta_ext[n.colony,1:4, t])-0.301))   
  eta_t[n.colony, 3, t] <-  (eta_ext[n.colony, 3, t] / (sum(eta_ext[n.colony,1:4, t])-0.301))  
  eta_t[n.colony, 4, t] <-  (eta_ext[n.colony, 4, t] / (sum(eta_ext[n.colony,1:4, t])-0.301))  
  eta_t[n.colony, 5, t] <- 0.301

  nu_t[n.colony, 1, t] <-  (nu_ext[n.colony, 1, t] / (sum(nu_ext[n.colony,1:4, t])-0.938)) 
  nu_t[n.colony, 2, t] <-  (nu_ext[n.colony, 2, t] / (sum(nu_ext[n.colony,1:4, t])-0.938)) 
  nu_t[n.colony, 3, t] <-  (nu_ext[n.colony, 3, t] / (sum(nu_ext[n.colony,1:4, t])-0.938)) 
  nu_t[n.colony, 4, t] <-  (nu_ext[n.colony, 4, t] / (sum(nu_ext[n.colony,1:4, t])-0.938))
  nu_t[n.colony, 5, t] <- 0.938
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/v12/models/semi_cmr_AE_v12_prior_p_hyper_AE.txt",
