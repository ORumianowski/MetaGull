  ...
  # load(file = "/lustre/rumianowskio/real_dataset/v1_filet/B.Rda")
  # load(file = "/lustre/rumianowskio/real_dataset/v1_filet/marr_filet.Rda")
  
  load(file = "1_formatage/real_dataset/v1_filet/B.Rda")
  load(file = "1_formatage/real_dataset/v1_filet/marr_filet5.Rda")
  ...
  marr_index_with_cmr = setdiff(  1:((n.years-1)*ns)  , 126  ) 
  ...
  no_detection_index = anti_join(all_col_year, detection_index, by = c("colony","year")) %>% as.matrix()
  ...
  cat(file = "2_models/2_models_for_real/v12/models/semi_cmr_AE_v12_prior_p_hyper.txt", "
  model {
   # -------------------------------------------------
    # Stages:
  ...
  out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/v12/models/semi_cmr_AE_v12_prior_p_hyper.txt",
