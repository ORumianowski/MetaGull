...
cat(file = "2_models/2_models_for_real/v12/models/semi_cmr_AE_v12_prior_p_hyper_int.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/v12/models/semi_cmr_AE_v12_prior_p_hyper_int.txt",
