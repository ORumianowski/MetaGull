...
survey_data = B %>% replace(is.na(.), 1) %>% replace(.,0, 1) # Survey dataset - Number of breeders reported # j'enlenve les NA pour chercher l'erreur
...
ni <- 30000; nb <- 10000; nc <- 3; nt <- 50; na <- 4000
