...
cat(file = "2_models/2_models_for_real/model_v10_7_3_3.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/model_v10_7_3_3.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/out1_integrated_v10_7_3_3_real.Rda")
