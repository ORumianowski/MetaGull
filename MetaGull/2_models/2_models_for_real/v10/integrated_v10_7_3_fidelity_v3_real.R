...
cat(file = "2_models/2_models_for_real/model_v10_7_3_fidelity_v3.txt", "
model {
 # -------------------------------------------------
  # Stages:
  ...
  eta[n.colony, 1] ~ dunif(0, 1)
  eta[n.colony, 2] ~ dunif(0, 1) 
  eta[n.colony, 3] ~ dunif(0, 1)
  eta[n.colony, 4] ~ dunif(0, 1) 
  eta[n.colony, 5] ~ dunif(0.3, 0.31)
  
  nu[n.colony, 1] ~ dunif(0, 1)
  nu[n.colony, 2] ~ dunif(0, 1)
  nu[n.colony, 3] ~ dunif(0, 1)
  nu[n.colony, 4] ~ dunif(0, 1) 
  nu[n.colony, 5] ~ dunif(0.93, 0.94)
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/model_v10_7_3_fidelity_v3.txt",
