...
# load(file = "/lustre/rumianowskio/real_dataset/peron_v1/B_peron.Rda")
# load(file = "/lustre/rumianowskio/real_dataset/peron_v1/marr_peron.Rda")

load(file = "1_formatage/real_dataset/peron_v1/B_peron.Rda")
load(file = "1_formatage/real_dataset/peron_v1/marr_peron.Rda")
...
load(file = "1_formatage/reading_effort/reading_effort_peron.Rda")
...
cat(file = "2_models/2_models_for_real/v13_peron/models/semi_cmr_peron_v1.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/v13_peron/models/semi_cmr_peron_v1.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/semi_cmr_peron_v1.Rda")
