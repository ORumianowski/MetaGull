...
#load(file = "1_formatage/real_dataset/peron_v1/B.Rda")
...
cat(file = "2_models/2_models_for_real/v13_peron/models/cmr_peron_v1.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/v13_peron/models/cmr_peron_v1.txt",
