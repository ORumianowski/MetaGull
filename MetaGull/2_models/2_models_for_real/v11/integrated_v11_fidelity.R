...
cat(file = "2_models/2_models_for_real/v11/models/model_v11_fidelity.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/v11/models/model_v11_fidelity.txt",
