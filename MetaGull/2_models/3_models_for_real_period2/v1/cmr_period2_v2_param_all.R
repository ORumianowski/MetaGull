...
# load(file = "/lustre/rumianowskio/real_dataset/peron_v1/B.Rda")
# load(file = "/lustre/rumianowskio/real_dataset/peron_v1/marr_peron.Rda")
# load(file = "/lustre/rumianowskio/reading_effort/reading_effort_peron.Rda")


#load(file = "1_formatage/real_dataset/period2/B_P2.Rda")
...
n.years = 34 # number of years in this survey
...
year2period = c(rep(1, (2006-1986+1)), rep(2, (2009-2007+1)), rep(3, (2019-2010+1)))
...
cat(file = "2_models/3_models_for_real_period2/v1/models/cmr_period2_v2_all.txt", "
model {
 # -------------------------------------------------
  # Stages:
  ...
  for (k in 1:nrow_detection_index) {
    po[detection_index[k, 1], detection_index[k, 2]] ~ dunif(0, 1)
  }
...
out1 <- jags(jags.data, inits, parameters, "2_models/3_models_for_real_period2/v1/models/cmr_period2_v2_all.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/out1_cmr_AE_v12.txt.Rda")
