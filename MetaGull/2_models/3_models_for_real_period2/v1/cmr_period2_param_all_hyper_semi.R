...
cat(file = "2_models/3_models_for_real_period2/v1/models/cmr_period2_v2_all_hyper_semi.txt", "
model {
 # -------------------------------------------------
  # Stages:
  ...
  for (t in 1:(n.years-1)){
    ...
    N[s,t+1] <- B[s,t] * rho[col2colclass[s]] * phi[1,year2period[t]] +
...
out1 <- jags(jags.data, inits, parameters, "2_models/3_models_for_real_period2/v1/models/cmr_period2_v2_all_hyper_semi.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/out1_hyper_semi_v1.Rda")
