...
cat(file = "2_models/3_models_for_real_period2/v1/models/cmr_period2_v2_all_hyper.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/3_models_for_real_period2/v1/models/cmr_period2_v2_all_hyper.txt",
             n.iter=ni, n.burnin=nb, n.chains=nc, n.thin=nt, n.adapt=na,
             parallel=TRUE)

save(out1, file = "/lustre/rumianowskio/cmr_period2_v2_all_hyper.Rda")
