...
cat(file = "2_models/3_models_for_real_period2/v1/models/cmr_period2_v1.txt", "
model {
 # -------------------------------------------------
  # Stages:
  ...
  # Period 1
  phi[1,1] ~  dunif(0, 1) # Survival prob. - First year
  phi[2,1]  ~ dunif(0, 1) # Survival prob. - Subadult and adults
  # Period 2
  phi[1,2] ~  dunif(0, 1) # Survival prob. - First year
  phi[2,2]  ~ dunif(0, 1) # Survival prob. - Subadult and adults
  # Period 3
  phi[1,3] ~  dunif(0, 1) # Survival prob. - First year
  phi[2,3]  ~ dunif(0, 1) # Survival prob. - Subadult and adults
...
out1 <- jags(jags.data, inits, parameters, "2_models/3_models_for_real_period2/v1/models/cmr_period2_v1.txt",
