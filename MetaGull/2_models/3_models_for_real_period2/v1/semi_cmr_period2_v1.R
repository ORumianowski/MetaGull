...
load(file = "1_formatage/real_dataset/period2/marr_period2_1.Rda")
...
cat(file = "2_models/2_models_for_real/v13_peron/models/semi_cmr_period2_v1.txt", "
model {
 # -------------------------------------------------
  # Stages:
...
out1 <- jags(jags.data, inits, parameters, "2_models/2_models_for_real/v13_peron/models/semi_cmr_period2_v1.txt",
